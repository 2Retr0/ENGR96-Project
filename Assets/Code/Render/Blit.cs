...
//	[CreateAssetMenu(menuName = "Cyan/Blit")]
    public class Blit : ScriptableRendererFeature
    {
        public class BlitPass : ScriptableRenderPass
        {
            ...
            private readonly RenderTargetHandle m_DestinationTexture;
            ...
            public BlitPass(RenderPassEvent renderPassEvent, BlitSettings settings, string tag)
            {
                ...
                if (settings.dstType == Target.TextureID) m_DestinationTexture.Init(settings.dstTextureId);
            }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                {
                    if (settings.overrideGraphicsFormat) opaqueDesc.graphicsFormat = settings.graphicsFormat;
            ...
            {
                if (settings.dstType == Target.TextureID) cmd.ReleaseTemporaryRT(m_DestinationTexture.id);
                if (source == destination ||
                    (settings.srcType == settings.dstType && settings.srcType == Target.CameraColor))
